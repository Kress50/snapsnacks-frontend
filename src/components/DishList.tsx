...
const DishList: React.FC<IDishListProps> = ({ menu, role, restaurantId }) => {
  ...
  return (
    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-4 gap-y-5 pb-10 pt-10 sm:grid-cols-2 lg:grid-cols-3">
      {menu?.map((dish) => (
