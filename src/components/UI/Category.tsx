...
const Category: React.FC<ICategoryProps> = ({ name, image }) => {
  return (
    <div className="grid w-20 cursor-pointer grid-rows-2 items-center justify-center text-center transition-all hover:scale-110 hover:text-amber-500 active:scale-105">
      <img
